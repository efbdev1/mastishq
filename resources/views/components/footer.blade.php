@if($homePageSettings->enable_footer)
    <footer class="bg-primary">
        ...
        <div id="cookie_directive_container" style="text-align: center;position: fixed;bottom: 0;padding: 10px;background: #0006;width: 100%;color: #ffffffd1; z-index: 999; display: none;">By continuing, you agree to our Cookie Policy. Yes, I'm fine with this. <a style="color:#FFF;" href="privacy-policy/" target="_blank">Learn more</a> <button style="background: #4c4949;border-color: #FFF;" id="cookie_accept" class="btn btn-success">Allow</button> <button style="background: #4c4949;border-color: #FFF;" id="cookie_dec" class="btn btn-success">Decline</button></div>
    </footer>
